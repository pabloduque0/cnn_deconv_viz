...
class StackNet(BaseNetwork):
    ...
    def create_model(self, img_shape, kernel_size=5):
        ...
        conv7 = layers.Conv2D(224, kernel_size=kernel_size, padding='same', kernel_initializer='he_normal', activation='relu')(
            maxpool3)
        ...
        conv9 = layers.Conv2D(224, kernel_size=kernel_size, padding='same', kernel_initializer='he_normal', activation='relu')(
            maxpool4)
        conv10 = layers.Conv2D(416, kernel_size=kernel_size, padding='same', kernel_initializer='he_normal', activation='relu')(
            conv9)
        ...
        up_conv1 = layers.Conv2D(416, kernel_size=kernel_size, padding='same',
        ...
        up_conv2 = layers.Conv2D(336, kernel_size=kernel_size, padding='same',
